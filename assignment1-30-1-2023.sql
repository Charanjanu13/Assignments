...
insert into customer_master values('C00001','RAMESH','CHANDRA','SHRAMA','DELHI',9543198345,'SERVICE','1976-12-06')
...
insert into customer_master values('C00009','ABISHEK',NULL,'DUTTA','KOLKATA',9856198761,'SERVICE','1973-05-22')
...
select firstname,occupation,customer_date_of_birth from customer_master order by customer_date_of_birth desc,firstname asc
